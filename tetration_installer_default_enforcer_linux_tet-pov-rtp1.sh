...
SCRIPT_VERSION="3.7.1.5-PATCH-3.7.1.22"
LOG_FILE=
CL_HTTPS_PROXY=""
PROXY_ARGS=
NO_PROXY=0
...
INSTALLATION_ID="603b5032756c81a39828e377f0689c3e7d1612803ddba73e2532e6f83ca596b03075a5efa929d76547f87225eee3036bf14a0f0535aa4086e089ec6da2147181819bbba4d03235fc3e26fc6cc8d8df58163603b125f2989a7857d953f2a69a81f3cac1639f1bd4d540c05eb6c77b88b5db"
...
function check_process {
  ...
  te=$(ps -e | awk '{print $NF}' | grep "^tet-engine$" | wc -l)
  ...
  case $DISTRO in
      RedHatEnterpriseServer | CentOS | OracleServer | AlmaLinux | RockyLinux)
        ...
        case $VERSION in
          ...
          9*)
            OPENSSL_REQUIRED_VERSION=
            check_pkg_version_rpm "openssl" "0"
            RPM_CHECK_RES=$?
            if [ $RPM_CHECK_RES -eq 0 ] ; then
              OPENSSL=1
            else
...
ACTIVATION_KEY=167117a6d6761c74a018406a60455e257793995f
...
[ ! -z ${GOLDEN_IMAGE} ] && echo "GOLDEN_HOSTNAME=$(hostname -s)" >> tet.user.cfg
